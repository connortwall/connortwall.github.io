...
<div class="mini-gallery">
Using material graph, I made a post process material that cell shades based on physical values. 
...
<div class="media-item">
 ...
 Using Houdini I created a procedural vine growth effect that uses any static mesh as input and can be modified during gameplay.
</div>
...
<div class="media-item">
  ...
  <div class="caption">Fish react to player's sound and physical interaction (color + emissive change).</div>
</div>
...
<div class="game-dev-bubbles">
  ...
  <a href="https://connortwall.itch.io/race-delivery-game"><div class="dev-bubble">Play Demo</div></a>
  <div class="dev-bubble" data-section="gameplay">Technical Details</div>
</div>
...
<h3><strong>Game Programmer</strong> (Unity, C#)</h3>
<h5>Timeframe: 1 week</h5>
  <h4>I programmed the <b>Enemy AI</b>, <b>Movement</b>, <b>Menu</b> systems in a
                            3rd-person 2.5D roguelike mini-game that uses simulated puppetry movement on a controller as
                            a primary game loop in Unity's HDRP on a team of 19.</h4>


<div class="game-dev-bubbles">
  <a href="https://github.com/connortwall/The-Amazing-Puppet-Show-Game"><div class="dev-bubble">View Code</div></a>
  <a href="https://connortwall.itch.io/amazing-puppet-show"><div class="dev-bubble">Play Demo</div></a>
  <div class="dev-bubble" data-section="gameplay">Technical Details</div>
</div>
...
<div style="display: flex;
  ...
  margin: 2rem auto;">
<iframe
                    src="https://www.youtube.com/embed/2Pw4DUqdKzo?si=srvZJOojNGJMIVDk? &autoplay=1"
                        style="width:100%;
                        max-width: 760px;
                        aspect-ratio: 16 / 9;"
                        title="YouTube video player"
...
<div style="display: flex;
  ...
  margin: 2rem auto;">
                <iframe
                    src="https://youtu.be/vceRLDM8p0w?si=_rI8LnaOUAoRCcSo? &autoplay=1"
                        style="width:100%;
                        max-width: 760px;
                        aspect-ratio: 16 / 9;"
                        title="YouTube video player"
...
I chose to explore the mechanic of echolocation because I think it offers unique, nature-based, and accessible gameplay challenges.</h4>
<div class="mini-modal-content">
<div class="mini-gallery">
  <div class="media-item">
                       <video autoplay muted loop style="\tmax-width: 100%; max-height: 100%;" class="zoomable-video" onclick="toggleMediaExpansion(this)">
